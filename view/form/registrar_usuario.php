...
<main class="registro-container">
    ...
    <form class="formulario" action="/controller/registrar_usuario.php" method="POST">
        ...
        <!-- Rol oculto según si es admin o no -->
        <input type="hidden" id="rol" name="rol" value="<?= $isAdmin ? 'tecnico' : 'cliente' ?>">

        <button type="submit" class="registrarse boton">
            <?= $isAdmin ? 'Registrar técnico' : 'Regístrate' ?>
        </button>
    </form>
</main>
